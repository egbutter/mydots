...
$_ = Invoke-WmiMethod Win32_Process Create -argumentlist $command -computername $computername -Credential $credential 
 
Write-Verbose "Testing connection"
Invoke-Command -computername $computername { Get-WmiObject Win32_ComputerSystem } -Credential $credential 
